...
module Mailing
  ...
  def send_message(destination, mail)
...
puts johns_postal_service.send_message(ellens_postal_service.street_address, Postcard.new('Greetings from Silicon Valley!'))
